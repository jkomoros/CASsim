	...
	render() {
		return html`
			<div class='container'>
				...
				<div>
					<options-control @option-changed=${this._handleOptionChanged} @open-dialog=${this._handleOpenDialog} .config=${this._simulation ? this._simulation.optionsConfig : null} .value=${this._simulation ? this._simulation.rawConfig : null} .name=${'Config'}></options-control>
				</div>
			</div>
		`;
	}
