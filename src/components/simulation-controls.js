	...
	render() {
		return html`
			<div class='container'>
				...
				<div>
					<options-control @option-changed=${this._handleOptionChanged} @open-dialog=${this._handleOpenDialog} .config=${this._simulation.optionsConfig} .value=${this._simulation.rawConfig} .name=${'Config'}></options-control>
				</div>
			</div>
		`;
	}
