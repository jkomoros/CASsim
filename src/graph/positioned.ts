...
*/
export class PositionedGraph<N extends GraphNodeValues = GraphNodeValues, E extends GraphEdge = GraphEdge> extends Graph<N, E> {
	...
	*/
	...
	nodeSizeMultiplier(_identifier : GraphNodeIdentifier<N, E>) : number {
		return 1.0;
	}
	...
	*/
	nodeSize(identifier : GraphNodeIdentifier<N, E>) : number {
	...
	*/
	calculateNodePosition(identifier : GraphNodeIdentifier<N, E>) : Position {
	...
	nodePosition(identifier : GraphNodeIdentifier<N, E>) : Position {
